 ...
 */
public class ZmqTaskPrintPic extends AsyncTask<String, Void, String> {
    private final MainActivity m_a;
    private final String m_addr;
    public ZmqTaskPrintPic(MainActivity a, String addr) {
        this.m_a = a;
        m_addr = addr;
    }
    ...
    protected String doInBackground(String... params) {
        ...
        socket.send("{\"cmd\":\"print_pic\",\"args\":[\"" + pic_name + "\"]}");
